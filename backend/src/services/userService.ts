...
export class UserService {
  ...
  static async updateProfile(userId: string, profileData: ProfileUpdateInput) {
    try {
  ...
  static async updatePreferences(userId: string, preferencesData: UserPreferencesInput) {
    try {
